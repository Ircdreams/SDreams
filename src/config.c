...
struct conf_item conf_items[] = {
	...
	{CONF_MISC, CONF_TINT|CONF_TFLAG, &ConfFlag, CF_HOSTHIDING, "host_hidding", "active le changement"
		"de l'host des users en <login>.<HIDDEN_HOST> (HIDDEN_HOST est paramétrable)", NULL},
	...
	{CONF_MISC, CONF_TINT, &MAXMEMOS, 0, "maxmemos", 
		   "Nombre maximum de memos que peut envoyer un user à une même personne", NULL},
	{CONF_MISC, CONF_TINT, &MAXALIAS, 0, "maxalias",
		   "Nombre maximum d'alias que peut créé un user", NULL},
	...
	{CONF_W2C, CONF_TPRIV|CONF_IP, NULL, 0, "allow_host",
		"IP autorisée à se connecter au serveur Webserv", cf_addw2chost},
