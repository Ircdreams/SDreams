...
#$Id: acinclude.m4,v 1.1 2005/10/18 18:51:36 progs Exp $
...
AC_ARG_WITH(mysqlclient-include, AC_HELP_STRING([--with-mysqlclient-include=DIR],[Directory pointing 
             to mysqlclient include files]),
            mysqlclient_include="$withval",
            mysqlclient_include="")

AC_ARG_WITH(mysqlclient-lib,
AC_HELP_STRING([--with-mysqlclient-lib=LIB],[Directory pointing to mysqlclient library
